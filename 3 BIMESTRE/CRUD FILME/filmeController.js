...
// obter os dados a partir do html
    ...
    const duracao = parseFloat(document.getElementById("inputDuracao").value);
    //verificar se o que foi digitado pelo USUÁRIO está correto
if(id && nome && diretor && dataLancamento && duracao ){// se tudo certo 
        switch (oQueEstaFazendo) {
            case 'inserindo':
                filme = new Filme(id,nome,diretor,dataLancamento,duracao);
                listaFilme.push(filme);
                mostrarAviso("Inserido na lista");
                break;
            case 'alterando':
                filmeAlterado = new Filme(id,nome,diretor,dataLancamento,duracao);
